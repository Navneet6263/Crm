...
const config = {
  ...
  api: {
    baseUrl: isDevelopment 
      ? (process.env.REACT_APP_API_URL || 'http://localhost:5004/api')
      : (process.env.REACT_APP_API_URL || 'https://crm-1-zn0m.onrender.com/api'),
  ...
  // Feature Flags
  features: {
    useMockData: false, // Use real API data for production
